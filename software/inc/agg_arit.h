...
class AGG_Arit : public MHDouble {
private:
    ...
    // Aplica el cruce aritmético a los padres
    void cruceAritmetico(Problem<double>& problem, const vector<tSolution<double>>& padres, vector<tSolution<double>>& hijos, int tam_sol);
