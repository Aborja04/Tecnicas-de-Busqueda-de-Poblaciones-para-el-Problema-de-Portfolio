...
class AGE_Arit : public MHDouble {
private:
    ...
    // Aplica el cruce aritmético a los padres de 2 en 2 y devuelve el indice del mejor hijo y del peor (por si hay que cambiarlo)
    void cruceAritmetico(Problem<double>& problem, const tSolution<double>& padre1, const tSolution<double>& padre2, int tam_sol, tSolution<double>& hijo1, tSolution<double>& hijo2);
