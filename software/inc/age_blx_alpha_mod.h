...
class AGE_BLX_ALPHA_MOD : public MHDouble {
private:
    ...
    void cruceBLX(Problem<double>& problem, const tSolution<double>& padre1, const tSolution<double>& padre2, int tam_sol, tSolution<double>& hijo1, tSolution<double>& hijo2,double &f1, double &f2);
    void obtenerDosMejores(double v0, double v1, double v2, double v3, int& indice_1, int& indice_2);
...
public:
    AGE_BLX_ALPHA_MOD() : MH() {}
    virtual ~AGE_BLX_ALPHA_MOD() {}
