...
ResultMHDouble AM_BEST::optimize(ProblemDouble &problem, int maxevals) {
    this->evaluaciones = 0;
...
void AM_BEST::cruceBLX(Problem<double>& problem, const vector<tSolution<double>>& padres, vector<tSolution<double>>& hijos, int tam_sol){
...
void AM_BEST::mutar(vector<tSolution<double>>& hijos, int tam_sol, double lo, double hi, vector<bool>& indices_mutados){
...
void AM_BEST::seleccionTorneo(const vector<tSolution<double>>& poblacion, const vector<double>& fitness_pob, vector<tSolution<double>>& padres, vector<double>& fitness_padres){
    for (int i = 0; i < TAM_POBLACION; i++) {
...
void AM_BEST::inicializarPosiciones(int tam_sol){
    posiciones.clear();
...
int AM_BEST::seleccionaMejor(const vector<double>& fitness_pob){
...
void AM_BEST::seleccionaNMejores(const vector<tSolution<double>>& poblacion, const vector<double>& fitness_pob, vector<int>& indices_mejores){
