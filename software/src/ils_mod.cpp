...
ResultMHDouble ILS_MOD::optimize(ProblemDouble &problem, int maxevals) {
    this->evaluaciones = 0;
...
void ILS_MOD::mutar(tSolution<double>& solucion, int numero_empresas_barajar){
...
void ILS_MOD::inicializarPosiciones(int tam_sol){
    posiciones.clear();
...
void ILS_MOD::inicializarIndicesEmpresas(int tam){
